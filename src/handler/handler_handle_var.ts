...
function handle_last_part(selected_text: string): string {
...
function handle_remove_prefix(selectedText: string) {
    ...
    throw Error("remove Prefix error")
}
...
function _handle_var_with_label(selectedText: string, command: string, routes: Array<[number, string, (text: string) => string, string]>): string {
